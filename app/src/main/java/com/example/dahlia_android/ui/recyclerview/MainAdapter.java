...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    private static AdapterTypeList adapterList;
//    public static UserProfile currentProfile;
    ...
    public int getItemViewType(int position) {
        ...
        else if( adapterList.get(position) instanceof Feed )
            return AdapterType.HOME_FEED_TYPE;
        else if( adapterList.get(position) instanceof FriendsList )
            return AdapterType.FRIENDS_LIST_TYPE;
        else if( adapterList.get(position) instanceof Groups )
            return AdapterType.GROUPS_TYPE;
        else if( adapterList.get(position) instanceof Messages)
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        UserProfile profile = (UserProfile) adapterList.get(position);
